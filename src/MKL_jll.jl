...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("856f044c-d86e-5d09-b602-aeab76dc8ba7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MKL", artifacts_toml) for e in artifacts["MKL"]]
...
if best_platform === nothing
    @debug("Unable to load MKL; unsupported platform $(triplet(platform_key_abi()))")
else
